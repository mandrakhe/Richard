...
namespace PROYECTO_NET.Controllers
{
    public class SkillsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NameSkill,Description")] Skill skill)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NameSkill,Description")] Skill skill)
        {
            if (id != skill.Id)
            {
                return NotFound();
